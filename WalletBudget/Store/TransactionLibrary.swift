...
enum CardLibrary {
    static let items: [LibraryItem] = [
        ...
        LibraryItem(name: "Apple Cash", systemImage: "dollarsign.circle.fill", color: .green),
        ...
        LibraryItem(name: "Amex Gold", systemImage: "creditcard.fill", color: .yellow),
        LibraryItem(name: "Amex Platinum", systemImage: "creditcard.fill", color: .gray),
        ...
        LibraryItem(name: "Chase Sapphire", systemImage: "creditcard.fill", color: .indigo),
        ...
        LibraryItem(name: "US Bank", systemImage: "building.columns.fill", color: .blue),
        LibraryItem(name: "PNC", systemImage: "building.columns.fill", color: .orange),
        LibraryItem(name: "TD Bank", systemImage: "building.columns.fill", color: .green),
        LibraryItem(name: "Truist", systemImage: "building.columns.fill", color: .purple),
        LibraryItem(name: "Ally", systemImage: "building.columns.fill", color: .purple),
        LibraryItem(name: "Barclays", systemImage: "building.columns.fill", color: .blue),
        LibraryItem(name: "Synchrony", systemImage: "creditcard.fill", color: .yellow),
        LibraryItem(name: "Robinhood", systemImage: "chart.line.uptrend.xyaxis", color: .green),
        LibraryItem(name: "Robinhood Gold", systemImage: "creditcard.fill", color: .yellow),
        LibraryItem(name: "SoFi", systemImage: "building.columns.fill", color: .blue),
        LibraryItem(name: "Chime", systemImage: "creditcard.fill", color: .green),
        LibraryItem(name: "Navy Federal", systemImage: "building.columns.fill", color: .blue),
        LibraryItem(name: "USAA", systemImage: "building.columns.fill", color: .blue),
        LibraryItem(name: "Fidelity", systemImage: "chart.pie.fill", color: .green),
        LibraryItem(name: "Charles Schwab", systemImage: "chart.pie.fill", color: .blue),
        LibraryItem(name: "Bilt", systemImage: "building.2.fill", color: .black),
        LibraryItem(name: "Venmo", systemImage: "dollarsign.circle.fill", color: .blue),
        LibraryItem(name: "PayPal", systemImage: "dollarsign.circle.fill", color: .blue),
        LibraryItem(name: "Cash App", systemImage: "dollarsign.circle.fill", color: .green),
